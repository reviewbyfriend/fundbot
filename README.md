...
## Update: LINE Admin Registration

ระบบนี้ปรับให้ “สมาชิกไม่ต้องลงทะเบียน” แต่ “แอดมินต้องลงทะเบียนใน LINE ส่วนตัว” เพื่อให้สลิปรอตรวจเด้งหาแอดมินส่วนตัว ไม่เด้งเข้ากลุ่ม

### วิธีลงทะเบียนแอดมิน
1. Owner เข้า `/admin/admins` แล้วสร้าง Admin Code ให้แต่ละคน
2. ให้แอดมินเปิดแชตส่วนตัวกับบอท แล้วพิมพ์:

```text
@fundbot สมัครแอดมิน ADMIN_CODE
```

3. เมื่อลงทะเบียนสำเร็จ ระบบจะบันทึก LINE userId ของแอดมินคนนั้น

### สิทธิ์คำสั่งใน LINE
- Member: `@fundbot สถานะของฉัน`
- Approver: `@fundbot รอตรวจ`
- Owner: `@fundbot เรียกเก็บ`, `@fundbot เปิดรอบ`, `@fundbot รายงาน`

### พฤติกรรมในกลุ่ม
ใน LINE Group บอทจะทำงานเฉพาะข้อความที่ขึ้นต้นด้วย `@fundbot` เท่านั้น เพื่อไม่ให้บอทตอบตอนคนคุยกันปกติ

### การแจ้งเตือนสลิปรอตรวจ
เมื่อสมาชิกส่งสลิปหรือใบรับเงินสด ระบบจะส่ง Flex Card ไปหาแอดมินที่ลงทะเบียน LINE แล้วแบบส่วนตัวเท่านั้น ไม่ส่งเข้ากลุ่ม
